...
const INTERACTION = readFileSync(join(process.cwd(), 'test', '__data__', 'interaction_1.json'))
const INDEXED_INTERACTION = readFileSync(join(process.cwd(), 'test', '__data__', 'interaction_indexed.json'))
